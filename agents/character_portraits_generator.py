...
# 根据以下描述生成角色{identifier}的全身正面肖像，背景为纯白色。人物应该在图像的中心，占据大部分的框架。直视前方。站着，双臂放松在身体两侧。自然的表情。 
# 特点:{特性} 
# 风格:{风格}
...
# 根据所提供的正面肖像，生成角色{identifier}的全身侧面肖像，背景为纯白色。人物应该在图像的中心，占据大部分的框架。面临着离开了。站着，双臂放松在身体两侧。
...
# 基于所提供的前视图肖像，生成角色{identifier}的全身后视图肖像，背景为纯白色。人物应该在图像的中心，占据大部分的框架。面部特征不能被看到。
